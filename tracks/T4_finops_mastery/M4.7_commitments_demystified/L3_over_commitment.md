...
PORTFOLIO HEALTH CHECK:
  ...
  Any below break-even utilization (1 - d)?
...
DISCOVERY:
  ...
  Break-even utilization for a 40% RI: 1 - 0.40 = 60%
  Current: 35% < 60% → the commitment LOSES money vs on-demand.
  You pay the committed rate on 100% of the hours but use only 35%;
  the overpayment on unused hours exceeds the discount earned. This
  is a net loss, not a smaller gain.
